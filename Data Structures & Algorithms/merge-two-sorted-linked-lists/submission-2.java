...
class Solution {
    public ListNode mergeTwoLists(ListNode list1, ListNode list2) {
        PriorityQueue<Integer> minHeap = new PriorityQueue<>();
        minHeap = populateMinHeap(minHeap, list1);
        minHeap = populateMinHeap(minHeap, list2);
        if (minHeap.isEmpty()) { return null; }
        ListNode newHead = new ListNode(minHeap.remove());
    ...
    public PriorityQueue<Integer> populateMinHeap(PriorityQueue<Integer> minHeap, ListNode list) {
